...
public class Backup {
    public static void main(String[] args) throws IOException {
        ...
        for (int i = 0; i < dbPaths.size(); i++) {
            ...
            writer.write("if exist " + dbNames.get(i)+ "_backup_*.rar forfiles /p " + dbDirectories.get(i) + " /m " + dbNames.get(i) + "_backup_*.rar /d -4 /c \"cmd /c del @file\"\n");
            writer.write("if exist " + dbNames.get(i)+ "_backup_*.7z forfiles /p " + dbDirectories.get(i) + " /m " + dbNames.get(i) + "_backup_*.7z /d -4 /c \"cmd /c del @file\"\n");
            writer.write("if exist " + dbNames.get(i) + "_backup_*.db forfiles /p " + dbDirectories.get(i) + " /m " + dbNames.get(i) + "_backup_*.db /d -4 /c \"cmd /c del @file\"\n");
